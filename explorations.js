...
$(document).ready( function () {
	...
	var waypointCollection = new waypoingCollection();
	var waypoingCollectionView = new waypointCollectionView({collection : waypointCollection});
